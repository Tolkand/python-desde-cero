...
#ejercicio 4 leccion_2_operadores

edad = int(input("Por favor, ingresa tu edad: ")) 
entrada = input("tienes entrada (s/n): ")
vip = input("eres vip (s/n): ") 

puedes = (edad >= 18 and entrada == 's') or vip == 's'

print("¿Puedes ingresar?", puedes) 
